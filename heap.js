...
//             if(right >length && this.heap[right] > large){
//                 large = right 
//             }
...
// console.log('sorted heap' , hp.heapSort());
...
// hp.insert(18)
// hp.insert(23)
// console.log('before removing a 4 : ' , hp);

// hp.remove(4)

// console.log('after removed the 4' , hp);

// console.log('sorted heap is this' , hp.heapSort());
...
//             if(right < large && this.heap[right] > this.heap[large]){
//                 large = right 
//             }
...
//         while(this.heap.length > 0){
//             sortd.push(this.heap[0])
//             this.remove(this.heap[0])
//         }
//         return sortd.reverse()
//     }
// }
...
//         [arr[index] , arr[this.heap.length - 1]] = [arr[this.heap.length - 1] , arr[index]]
